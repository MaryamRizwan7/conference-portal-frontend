...
import DashboardLayout from "../../components/DashboardLayout"; // use your updated layout
      ...
      <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
        ...
        <div className="px-8 pb-12 -mt-16">
          <div className="relative flex flex-col items-center sm:flex-row sm:items-end sm:space-x-5">
            ...
            {/* Avatar */}
            <div className="h-32 w-32 rounded-2xl ring-4 ring-white bg-teal-50 flex items-center justify-center overflow-hidden shadow-lg">
              <svg className="w-16 h-16 text-teal-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <form onSubmit={handleSubmit} className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-200 focus:bg-white focus:outline-none transition-all duration-200 shadow-sm hover:border-gray-300"
            ...
            <div className="md:col-span-2 pt-4">
              <button
                type="submit"
                className="w-full md:w-auto px-8 py-4 text-white font-bold rounded-xl transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-teal-900/20"
                style={{ background: "linear-gradient(135deg, #2D5561, #4B707A)" }}
              >
                Update Profile
              </button>
