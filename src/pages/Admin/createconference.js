...
function AdminConferenceCreationForm() {
  ...
  return (
    <Layout title="Admin — Create Conference">
              ...
              <form onSubmit={handleSubmit} className="p-8 space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-gray-500 uppercase tracking-wider">Conference Full Name <span className="text-teal-500">*</span></label>
                      <input
                        type="text"
                        name="conferenceName"
                    ...
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-gray-500 uppercase tracking-wider">Acronym <span className="text-teal-500">*</span></label>
                      <input
                        type="text"
                        name="acronym"
                    ...
                    <div className="md:col-span-2 space-y-1.5">
                      <label className="text-xs font-bold text-gray-500 uppercase tracking-wider">Official Website</label>
                      <input
                        type="url"
                        name="webPage"
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    {[
                      ...
                      <label
                        key={value}
                        className={`relative flex p-4 cursor-pointer rounded-xl border-2 transition-all duration-200 ${
                          formData.mode === value ? "border-teal-600 bg-teal-50" : "border-gray-100 hover:border-gray-200"
                        }`}
                      >
                        <input
                          type="radio"
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-gray-500 uppercase tracking-wider">Expertise Required (comma-separated) <span className="text-teal-500">*</span></label>
                      <input
                        type="text"
                        name="expertise"
