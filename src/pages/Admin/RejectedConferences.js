      ...
      <div className="p-8">
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-500 font-medium">
            Review previously rejected conference requests. You may re-approve them if needed.
          </p>
        </div>
                ...
                <tbody className="bg-white divide-y divide-gray-100">
                  {conferences.map((conference) => (
                    <tr key={conference._id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-600">{conference.submissionDeadline ? conference.submissionDeadline.slice(0, 10) : "-"}</td>
                      <td className="px-6 py-4 text-sm text-gray-600">{conference.startDate ? conference.startDate.slice(0, 10) : "-"}</td>
                      <td className="px-6 py-4 text-sm text-gray-600">{conference.topics && conference.topics.join(", ")}</td>
